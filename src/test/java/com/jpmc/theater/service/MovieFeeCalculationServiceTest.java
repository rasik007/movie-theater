...
public class MovieFeeCalculationServiceTest {
    ...
    public void specialMovieWith20PercentDiscount() {
        ...
        assertEquals(10.00, movieFeeCalculationService.calculateTicketPrice(showing).doubleValue());
    }
    ...
    public void timeBaseDiscount() {
        ...
        assertEquals(2.50, movieFeeCalculationService.getDiscountByShowTime(showing).doubleValue());
        ...
        assertEquals(0, movieFeeCalculationService.getDiscountByShowTime(showing).doubleValue());
    ...
    public void sequenceCodeBasedDiscount() {
        ...
        assertEquals(7.00, movieFeeCalculationService.calculateTicketPrice(showing).doubleValue());
        ...
        assertEquals(8.00, movieFeeCalculationService.calculateTicketPrice(showing).doubleValue());

        spiderMan = new Movie("Spider-Man: No Way Home", Duration.ofMinutes(90),10, 0);
        showing = new Showing(spiderMan, 7, LocalDateTime.of(LocalDate.now(), LocalTime.of(17, 0)));
        assertEquals(9.00, movieFeeCalculationService.calculateTicketPrice(showing).doubleValue());
